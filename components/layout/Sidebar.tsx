...
export function Sidebar() {
  ...
  return (
    <aside className="w-[60px] sm:w-[76px] lg:w-[260px] flex-shrink-0 bg-[var(--bg-secondary)] border-r border-[var(--border-default)] flex flex-col z-50 transition-all duration-300">
      {/* ── Branding ── */}
      <div className="pt-4 sm:pt-8 pb-3 sm:pb-6 px-0 lg:px-6 flex flex-col items-center">
        <h1 className="font-display text-2xl sm:text-3xl lg:text-5xl text-[var(--ikf-red)] leading-none tracking-wide">
          IKF
        </h1>
      ...
      <div className="px-2 sm:px-4 lg:px-6 mb-3 sm:mb-4">
                  ...
                  return (
                    <li key={item.id}>
                      <button
                        ...
                        className={cn(
                          "relative w-full flex items-center justify-center lg:justify-start gap-3 px-0 lg:px-3 py-2.5 sm:py-3 lg:py-2.5 rounded-lg font-body text-sm font-medium transition-all duration-200 group overflow-hidden",
                          isActive
