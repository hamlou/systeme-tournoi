...
export type RoundEventType = 'round-start' | 'round-end' | 'wosk-stop' | 'doctor' | 'yellow-card' | 'red-card' | 'cards-cleared' | 'deduction' | 'score-input' | 'ippon' | 'waza-ari' | 'yuko' | 'immobilisation' | 'note' | 'decision' | 'ko' | 'tko' | 'ko-tko' | 'ippon-result' | 'disqualification' | 'draw' | 'match-end' | 'match-start';
